...
class BatchImport {
	 ...
	 * Get things started.
	 *
	 * @param string  $_file file uploaded.
	 * @param integer $_step step to process.
	 */
	...
	public function can_import() {
		return (bool) apply_filters( 'pno_import_capability', current_user_can( $this->capability_type ) );
	}
