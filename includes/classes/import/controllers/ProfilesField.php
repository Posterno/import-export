<?php
/**
 * Profiles Field importer controller.
 *
...
/**
 * Profiles Field importer controller - handles file upload and forms in admin.
 */
class ProfilesField extends BaseController {
	...
	public function __construct() {
		...
		$this->page_title              = esc_html__( 'Import profiles fields from a CSV File', 'posterno' );
	 ...
	 * @return \PosternoImportExport\Import\CsvImporterProfilesField
	 */
	public static function get_importer( $file, $args = array() ) {
		$importer_class = apply_filters( 'posterno_profilesfield_csv_importer_class', '\PosternoImportExport\Import\CsvImporterProfilesField' );
		$args           = apply_filters( 'posterno_profilesfield_csv_importer_args', $args, $importer_class );
	...
	protected function auto_map_columns( $raw_headers, $num_indexes = true ) {
		...
		$initial_columns = $this->normalize_columns_names(
			apply_filters(
				'posterno_csv_profilesfield_import_mapping_default_columns',
				array(
					__( 'ID', 'posterno' )    => 'id',
		...
		$special_columns = $this->get_special_columns(
			$this->normalize_columns_names(
				apply_filters(
					'posterno_csv_profilesfield_import_mapping_special_columns',
					array(
		...
		return apply_filters( 'posterno_csv_profilesfield_import_mapped_columns', $headers, $raw_headers );
	}
	...
	protected function get_mapping_options( $item = '' ) {
		...
		return apply_filters( 'posterno_csv_profilesfield_import_mapping_options', $options, $item );
	}
}
