...
/**
 * Export Posterno registration fields.
 */
class CsvRegistrationFieldsExporter extends CsvBatchExporter {
	 ...
	 * @var string
	 */
	protected $export_type = 'registration-fields';
	...
	protected function generate_row_data( $id ) {
		...
		/**
		 * Filter: allow developers to customize data retrive for rows of the CSV registration fields exporter.
		 *
