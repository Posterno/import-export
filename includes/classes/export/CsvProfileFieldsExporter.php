...
/**
 * Export Posterno profile fields.
 */
class CsvProfileFieldsExporter extends CsvBatchExporter {
	 ...
	 * @var string
	 */
	protected $export_type = 'profile-fields';
	...
	public function get_default_column_names() {
		...
		/**
		 * Filter: allow developers to customize csv columns for the profile fields exporter.
		 */
	...
	protected function generate_row_data( $id ) {
		...
		/**
		 * Filter: allow developers to customize data retrive for rows of the CSV profile fields exporter.
		 *
