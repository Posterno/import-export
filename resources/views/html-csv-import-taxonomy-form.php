...
$taxonomies = pno_get_registered_listings_taxonomies();
	...
	<section>
		<table class="form-table posterno-importer-options">
			<tbody>
				...
				<tr>
					<th><label for="posterno-importer-taxonomy"><?php echo esc_html__( 'Select taxonomy' ); ?></label><br/></th>
					<td>
						<select name="taxonomy" id="posterno-importer-taxonomy">
							<?php foreach ( $taxonomies as $id => $name ) : ?>
								<option value="<?php echo esc_attr( $id ); ?>"><?php echo esc_html( $name ); ?></option>
							<?php endforeach; ?>
						</select>
						<label for="posterno-importer-taxonomy"><?php echo esc_html__( 'Select the taxonomy where you are going to import or update terms.' ); ?></label>
					</td>
				</tr>
				<tr>
