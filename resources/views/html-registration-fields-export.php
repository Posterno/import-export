...
<div class="pno-admin-title-area">
	<div class="wrap">
		<h2><?php esc_html_e( 'Export registration custom fields' ); ?></h2>
...
<div class="wrap posterno">
	<h1 class="screen-reader-text"><?php esc_html_e( 'Export registration custom fields' ); ?></h1>

	<div class="posterno-exporter-wrapper">
		<form class="posterno-exporter">
			<header>
				<span class="spinner is-active"></span>
				<h2><?php esc_html_e( 'Export registration custom fields to a CSV file', 'posterno' ); ?></h2>
				<p><?php esc_html_e( 'This tool allows you to generate and download a CSV file containing a list of all registration custom fields configured on this website.', 'posterno' ); ?></p>
			</header>
			<section>
