	...
	<div class="posterno-exporter-wrapper">
		<form class="posterno-exporter">
			<header>
				...
				<h2><?php esc_html_e( 'Export emails to a CSV file', 'posterno' ); ?></h2>
				<p><?php esc_html_e( 'This tool allows you to generate and download a CSV file containing a list of all emails configured on the site.', 'posterno' ); ?></p>
			</header>
			<section>
